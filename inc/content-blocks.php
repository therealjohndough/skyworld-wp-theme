    ...
    <div class="wrap">
        ...
        <div class="content-blocks-container">
            ...
            <div class="content-block-section">
                ...
                <a href="<?php echo admin_url('edit.php?post_type=sw-product'); ?>" class="button button-secondary">Manage Products</a>
            </div>
            ...
            <div class="content-block-section">
                ...
                <a href="<?php echo admin_url('edit.php?post_type=sw-product'); ?>" class="button button-primary">Manage Products</a>
                <a href="<?php echo admin_url('post-new.php?post_type=sw-product'); ?>" class="button button-secondary">Add New Product</a>
            </div>
...
function skyworld_add_content_block_meta_boxes() {
    ...
    $post_types = array('post', 'strain', 'sw-product');
...
function skyworld_add_content_blocks_admin_bar($wp_admin_bar) {
    ...
    $wp_admin_bar->add_node(array(
        ...
        'href' => admin_url('edit.php?post_type=sw-product'),
    ));
}
?>