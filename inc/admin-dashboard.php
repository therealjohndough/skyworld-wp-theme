...
// Disable Gutenberg completely for client safety
    ...
    <div class="wrap skyworld-admin-dashboard">
        ...
        <div class="skyworld-help-section">
            ...
            <div class="help-cards">
                ...
                <div class="help-card">
                    <h4><i class="skyworld-icon icon-chart-line"></i> SEO Management</h4>
    ...
    <div class="wrap">
        ...
        <form method="post" class="skyworld-quick-actions-form">
            <div class="action-grid">
                ...
                <div class="action-item">
                    <h3><i class="skyworld-icon icon-activity"></i> Update Inventory</h3>
            ...
            <?php if ( $locations ): ?>
                <?php foreach ( $locations as $location ): ?>
                    ...
                    <div class="location-card">
                        ...
                        <?php endif; ?>
                        <?php if ( $phone ): ?>
                            <p><strong><i class="skyworld-icon icon-small"></i> Phone:</strong> <a href="tel:<?php echo $phone; ?>"><?php echo $phone; ?></a></p>
                        <?php endif; ?>
                        <?php if ( $hours ): ?>
